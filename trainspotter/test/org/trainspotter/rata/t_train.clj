...
(deftest get-stops
  (let [train-data
    ...
    (is (= '({:stationShortCode "LPV" :stationUICCode 68 :countryCode "FI" :type "ARRIVAL" :trainStopping true :commercialStop true :commercialTrack "1" :cancelled false :scheduledTime "2017-01-30T05:16:24.000Z" :actualTime "2017-01-30T05:16:07.000Z" :differenceInMinutes 0 :causes []}
             {:stationShortCode "LPV" :stationUICCode 68 :countryCode "FI" :type "DEPARTURE" :trainStopping true :commercialStop true :commercialTrack "1" :cancelled false :scheduledTime "2017-01-30T05:17:00.000Z" :actualTime "2017-01-30T05:17:04.000Z" :differenceInMinutes 0 :causes []}) (train/get-stops train-data "LPV")))))
